...
<body class="font-sans bg-brand-light bg-[url('{{ asset('images/ok.jpeg') }}')] bg-cover bg-center bg-no-repeat min-h-screen flex flex-col items-center justify-center text-gray-800 p-6">
    ...
    <div class="bg-white p-10 md:p-12 w-full max-w-md rounded-3xl shadow-xl border border-green-50 relative overflow-hidden">
        ...
        <form method="POST" action="{{ url('/admin/login') }}" novalidate class="relative z-10 space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="nama" name="nama" value="{{ old('nama', $rememberedUser) }}" placeholder="Masukkan nama Anda" required
        ...
        <div class="mt-8 text-center relative z-10 flex flex-col gap-3">
            <a href="/" class="text-sm font-medium text-gray-500 hover:text-brand transition flex items-center justify-center gap-2">
